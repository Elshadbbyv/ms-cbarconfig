...
public class CurrencyApiResponseDto {
    ...
    public CurrencyApiResponseDto() {
    }

    public CurrencyApiResponseDto(String date, String name, String description, List<CurrencyType> valType) {
        this.date = date;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CurrencyApiResponseDto that)) return false;
